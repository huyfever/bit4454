...
<body>
  <nav>
    <ul class="nav nav-pills nav-justified">
      ...
      <li class="active"><a href="RecallViolationSearch.php">Recall/Violations</a></li>
...
<div4>
  ...
  if ($result3->num_rows > 0) {
    echo "<table border='2' id='recallTable'>
    <tr>
    <th style='text-align: center; width: 200px;'>RecallID</th>
    <th>Manufacturer</th>
    <th>Model</th>
    <th>RecalledDate</th>
    <th>Reason</th>
    ...
    while($row = $result3->fetch_assoc()){
      echo "<tr>";
      echo "<td style='width: 200px; text-align: center;'>" . $row['RecallID'] . "</td>";
      echo "<td style='width: 500px; text-align: center;'>" . $row['Manufacturer'] . "</td>";
      echo "<td style='width: 200px; text-align: center;'>" . $row['Model'] . "</td>";
      echo "<td style='width: 200px; text-align: center;'>" . $row['RecallDate'] . "</td>";
      echo "<td style='width: 200px; text-align: center;'>" . $row['Reason'] . "</td>";
      echo "<td style='width: 200px; text-align: center;'>" . $row['ManufacturerCountry'] . "</td>";
      echo "</tr>";
    }
